    ...
    return (
      <div style={{ textAlign: "center", padding: "5rem 2rem", maxWidth: "600px", margin: "4rem auto" }}>
        ...
        <p style={{ color: "var(--color-text-muted)", fontSize: "1rem", lineHeight: "1.6" }}>
          The minimum order value for this website is <strong style={{ color: "var(--color-text)" }}>{formatPrice(830)}</strong> (equivalent to $830 USD). 
        ...
        <p style={{ color: "var(--color-text-muted)", marginTop: "1rem", fontSize: "0.95rem" }}>
          Please add at least <strong style={{ color: "var(--color-text)" }}>{formatPrice(830 - total)}</strong> more in products to complete checkout.
        </p>
